...
function Myaccount() {
    const [countries, setCountries] = useState([
        { id: 1, firstname: "Anil", middlename: "Kumar", lastname: "Sah", address: "123 Main St", city: "Delhi", pincode: "110001", mobile: "9876543210", detail: "Leading Provider of IT Solutions and Training Services", degree: "MCA", skill: ".NET Core", passyear: "2011", experience: "3+ Years" },
    ]);
    ...
    const handleAddCountry = () => {
        if (newCountry.trim() !== "") {
            ...
            setCountries([...countries, { id: newId, firstname: newFirstname, middlename: newMiddlename, lastname: newLastname, address: newAddress, city: newCity, pincode: newPincode, mobile: newMobile, detail: newDetail, degree: newDegree, skill: newSkill, passyear: newPassyear, experience: newExperience }]);
            setNewCountry("");
    ...
    return (
        <div className="container mt-4">
            <h2>My Account</h2>
            <button className="btn btn-primary mb-3" onClick={() => setShowAddModal(true)}>Update Details</button>
            ...
            {showAddModal && (
                ...
                <input type="text" className="form-control" placeholder="Country Name" value={newCountry} onChange={e => setNewCountry(e.target.value)} />
                                ...
                                <form>
                                    <div className="row">
                                        ...
                                        <div className="mb-3 col-md-6">
                                            ...
                                            <input type="text" className="form-control" placeholder="First Name" value={newFirstname} onChange={e => setNewFirstname(e.target.value)} />
                                        </div>

                                        {/* Middle Name */}
                                        <div className="mb-3 col-md-6">
                                            <label className="form-label">Middle Name</label>
                                            <input type="text" className="form-control" placeholder="Middle Name" value={newMiddlename} onChange={e => setNewMiddlename(e.target.value)} />
                                        </div>

                                        {/* Last Name */}
                                        <div className="mb-3 col-md-6">
                                            <label className="form-label">Last Name</label>
                                            <input type="text" className="form-control" placeholder="Last Name" value={newLastname} onChange={e => setNewLastname(e.target.value)} />
                                        </div>
                                        ...
                                        <div className="mb-3 col-md-6">
                                            ...
                                            <input type="text" className="form-control" placeholder="City" value={newCity} onChange={e => setNewCity(e.target.value)} />
                                        </div>

                                        {/* Pincode */}
                                        <div className="mb-3 col-md-6">
                                            <label className="form-label">Pincode</label>
                                            <input type="text" className="form-control" placeholder="Pincode" value={newPincode} onChange={e => setNewPincode(e.target.value)} />
                                        </div>

                                        {/* Mobile No */}
                                        <div className="mb-3 col-md-6">
                                            <label className="form-label">Mobile No.</label>
                                            <input type="text" className="form-control" placeholder="Mobile Number" value={newMobile} onChange={e => setNewMobile(e.target.value)} />
                                        </div>
                                        ...
                                        <div className="mb-3 col-12">
                                            ...
                                            <textarea
                                                ...
                                                rows="3"
                                                placeholder="Enter Complete Details..." value={newDetail} onChange={e => setNewDetail(e.target.value)}
                                            />
                                        </div>
                            ...
                            <div className="modal-footer">
                                ...
                                <button className="btn btn-primary" onClick={handleAddCountry}>Update</button>
                            </div>
                        </div>
                    </div>
                </div>
