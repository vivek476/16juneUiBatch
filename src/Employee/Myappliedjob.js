            ...
            <table className="table table-bordered table-striped">
                ...
                <tbody>
                    ...
                    {paginatedCountries.length === 0 && (
                        <tr>
                            <td colSpan="2" className="text-center">No Job Found.</td>
                        </tr>
                    )}
                </tbody>
            </table>
                    ...
                    <div className="modal-dialog">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <input type="text" className="form-control" placeholder="Company Name" value={newCompany} onChange={e => setNewCompany(e.target.value)} />
                            </div>
